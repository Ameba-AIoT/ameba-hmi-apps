/**
 * @file smarthub_app_ev_charging.c
 *
 */
...
static lv_obj_t * widget2_chart_label(smarthub_ctx_t * c, lv_obj_t * parent, const char * text);
static void create_widget2(smarthub_ctx_t * c, lv_obj_t * widgets);
static lv_obj_t * create_widget3_info(smarthub_ctx_t * c, lv_obj_t * parent, const lv_image_dsc_t * img_dsc,
...
void smarthub_app_ev_charging(lv_obj_t * base_obj)
{
...
static void anim_state_apply(anim_state_t * anim_state, int32_t v)
{
    ...
    lv_span_set_text(lv_spangroup_get_child(anim_state->spent_spangroup_small, 0), buf);
...
static void create_widget1(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    lv_obj_t * title_box = smarthub_simple_container_create(widget, true, c->sz->gap[1], LV_FLEX_ALIGN_START);
    ...
    lv_obj_t * spent_box = smarthub_simple_container_create(widget, true, c->sz->gap[2], LV_FLEX_ALIGN_START);
    ...
    lv_spangroup_new_span(total_spent_span);
    ...
    lv_style_set_text_opa(lv_span_get_style(total_spent_label), LV_OPA_40);

    lv_obj_t * total_spent_bar = smarthub_simple_container_create(spent_box, false, c->sz->gap[1],
                                                                          LV_FLEX_ALIGN_START);
    ...
    lv_obj_t * gas_equivalent_bar = smarthub_simple_container_create(spent_box, false, c->sz->gap[1],
                                                                             LV_FLEX_ALIGN_START);
    ...
    lv_style_set_text_opa(lv_span_get_style(gas_equivalent_label), LV_OPA_40);
    lv_spangroup_refr_mode(gas_equivalent_span);
}
...
static void create_widget2(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    lv_obj_t * charged_box = smarthub_simple_container_create(totals_box, true, c->sz->gap[2], LV_FLEX_ALIGN_START);
    ...
    lv_obj_t * charged_amount_box = smarthub_simple_container_create(charged_box, false, c->sz->gap[1],
                                                                             LV_FLEX_ALIGN_END);
    ...
    lv_obj_t * spent_box = smarthub_simple_container_create(totals_box, true, c->sz->gap[2], LV_FLEX_ALIGN_START);
                                      ...
                                      const char * text, const char * unit)
{
    ...
    lv_obj_t * sub_box1 = smarthub_simple_container_create(info, true, c->sz->gap[2], LV_FLEX_ALIGN_START);
    ...
    lv_obj_t * sub_box2 = smarthub_simple_container_create(info, false, c->sz->gap[1], LV_FLEX_ALIGN_END);
...
static void create_widget3(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    lv_obj_t * info_box = smarthub_simple_container_create(widget, false, c->sz->gap[5], LV_FLEX_ALIGN_CENTER);
