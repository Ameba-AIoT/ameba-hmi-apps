...
LV_FONT_DECLARE(font_smarthub_roboto_medium_12)
LV_FONT_DECLARE(font_smarthub_roboto_medium_16)
LV_FONT_DECLARE(font_smarthub_roboto_medium_24)
LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_30)
LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_36)
LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_60)
LV_FONT_DECLARE(font_smarthub_roboto_slab_light_120)
LV_FONT_DECLARE(font_smarthub_roboto_slab_light_160)
LV_FONT_DECLARE(font_smarthub_roboto_slab_regular_30)
LV_FONT_DECLARE(font_smarthub_roboto_slab_regular_60)

LV_FONT_DECLARE(font_smarthub_roboto_slab_regular_20)
LV_FONT_DECLARE(font_smarthub_roboto_slab_regular_40)
LV_FONT_DECLARE(font_smarthub_roboto_slab_regular_45)
LV_FONT_DECLARE(font_smarthub_roboto_slab_regular_90)

LV_FONT_DECLARE(font_smarthub_roboto_slab_light_80)
LV_FONT_DECLARE(font_smarthub_roboto_slab_light_107)
LV_FONT_DECLARE(font_smarthub_roboto_slab_light_180)
LV_FONT_DECLARE(font_smarthub_roboto_slab_light_240)

LV_FONT_DECLARE(font_smarthub_roboto_medium_8)
LV_FONT_DECLARE(font_smarthub_roboto_medium_11)
LV_FONT_DECLARE(font_smarthub_roboto_medium_18)
LV_FONT_DECLARE(font_smarthub_roboto_medium_36)

LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_20)
LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_24)
LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_40)
LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_45)
LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_54)
LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_90)

LV_FONT_DECLARE(font_smarthub_roboto_slab_regular_24)
LV_FONT_DECLARE(font_smarthub_roboto_slab_regular_50)
LV_FONT_DECLARE(font_smarthub_roboto_slab_light_100)
LV_FONT_DECLARE(font_smarthub_roboto_slab_light_130)
LV_FONT_DECLARE(font_smarthub_roboto_slab_medium_10)
LV_FONT_DECLARE(font_smarthub_roboto_slab_medium_13)
LV_FONT_DECLARE(font_smarthub_roboto_slab_medium_20)
LV_FONT_DECLARE(font_smarthub_roboto_slab_bold_50)
...
const smarthub_theme_t smarthub_theme_light = {
    .base = LV_COLOR_MAKE(0xff, 0xff, 0xff),
    .accent = LV_COLOR_MAKE(0xcc, 0x00, 0x00),
};

const smarthub_theme_t smarthub_theme_dark = {
    .base = LV_COLOR_MAKE(0x00, 0x00, 0x00),
    .accent = LV_COLOR_MAKE(0xe1, 0x2b, 0x17),
};

const smarthub_sizes_t smarthub_sizes_all[SIZE_COUNT] = {
    {
...
lv_obj_t * smarthub_base_obj_create(const char * assets_path,
                                            const char * logo_path,
                                            const char * slides_path,
                                            smarthub_exit_cb_t exit_cb)
{
    smarthub_ctx_t * c = lv_malloc_zeroed(sizeof(smarthub_ctx_t));
    LV_ASSERT_MALLOC(c);
    ...
    if(!is_exact) {
        LV_LOG_WARN("a display size of exactly 800x480, 1280x720, or 1920x1080 is recommended for the smart-hub demo");
    }
    c->sz = &smarthub_sizes_all[size];
    ...
    for(uint32_t i = 0; i < IMG_COUNT; i++) {
        char path_buf[256];
        int chars = lv_snprintf(path_buf, sizeof(path_buf), "%s/img_smarthub_%s_%s.png",
                                assets_path, image_details[i].name, size_prefix);
        LV_ASSERT(chars < (int)sizeof(path_buf));
        c->imgs[i] = smarthub_image_preload(path_buf, image_details[i].cf, LV_SCALE_NONE);
    }
    ...
    lv_subject_init_pointer(&c->th, (void *)&smarthub_theme_dark);
    c->th.user_data = c;
    ...
    if(fs_res == LV_FS_RES_OK) {
        ...
        for(int32_t i = 1; ; i++) {
            ...
            lv_image_dsc_t * loaded_draw_buf = smarthub_image_preload(buf, LV_COLOR_FORMAT_NATIVE, scale);
...
lv_obj_t * smarthub_simple_container_create(lv_obj_t * parent, bool vertical, int32_t pad,
...
void smarthub_label_bind_temperature(lv_obj_t * label, lv_subject_t * subject, smarthub_ctx_t * c)
{
...
void smarthub_theme_observer_image_src_cb(lv_observer_t * observer, lv_subject_t * subject)
{
    lv_obj_t * obj = lv_observer_get_target_obj(observer);
    lv_image_dsc_t ** pair = lv_observer_get_user_data(observer);

    const smarthub_theme_t * th = lv_subject_get_pointer(subject);

    if(th == &smarthub_theme_light) {
...
void smarthub_theme_observer_obj_bg_image_src_cb(lv_observer_t * observer, lv_subject_t * subject)
{
    lv_obj_t * obj = lv_observer_get_target_obj(observer);
    lv_image_dsc_t ** pair = lv_observer_get_user_data(observer);
...
lv_image_dsc_t * smarthub_image_preload(const void * src, lv_color_format_t cf, int32_t scale)
{
    lv_image_header_t header;
...
static void init_fonts_sm(lv_style_t * fonts)
{
    lv_style_set_text_font(&fonts[FONT_HEADING_MD], &font_smarthub_roboto_slab_regular_20);
    lv_style_set_text_font(&fonts[FONT_HEADING_LG], &font_smarthub_roboto_slab_regular_40);
    lv_style_set_text_font(&fonts[FONT_HEADING_XL], &font_smarthub_roboto_slab_light_80);
    lv_style_set_text_font(&fonts[FONT_HEADING_XXL], &font_smarthub_roboto_slab_light_107);
    lv_style_set_text_font(&fonts[FONT_LABEL_XS], &font_smarthub_roboto_medium_8);
    lv_style_set_text_line_space(&fonts[FONT_LABEL_XS],
                                 30 * lv_font_get_line_height(&font_smarthub_roboto_medium_8) / 100); /* +30% */
    /* lv_style_set_text_letter_space(&fonts[FONT_LABEL_XS], 197 * lv_font_get_letter_space(&font_smarthub_roboto_medium_8) / 200); */ /* -1.5% */
    lv_style_set_text_font(&fonts[FONT_LABEL_SM], &font_smarthub_roboto_medium_11);
    lv_style_set_text_font(&fonts[FONT_LABEL_MD], &font_smarthub_roboto_medium_16);
    lv_style_set_text_font(&fonts[FONT_LABEL_LG], &font_smarthub_roboto_slab_bold_20);
    lv_style_set_text_font(&fonts[FONT_LABEL_XL], &font_smarthub_roboto_slab_bold_24);
    lv_style_set_text_font(&fonts[FONT_LABEL_2XL], &font_smarthub_roboto_slab_bold_40);
}

static void init_fonts_msm(lv_style_t * fonts)
{
    lv_style_set_text_font(&fonts[FONT_HEADING_MD], &font_smarthub_roboto_slab_regular_24);
    lv_style_set_text_font(&fonts[FONT_HEADING_LG], &font_smarthub_roboto_slab_regular_50);
    lv_style_set_text_font(&fonts[FONT_HEADING_XL], &font_smarthub_roboto_slab_light_100);
    lv_style_set_text_font(&fonts[FONT_HEADING_XXL], &font_smarthub_roboto_slab_light_130);
    lv_style_set_text_font(&fonts[FONT_LABEL_XS], &font_smarthub_roboto_slab_medium_10);
    lv_style_set_text_line_space(&fonts[FONT_LABEL_XS], 30 * lv_font_get_line_height(&font_smarthub_roboto_slab_medium_10) / 100);
    lv_style_set_text_font(&fonts[FONT_LABEL_SM], &font_smarthub_roboto_slab_medium_13);
    lv_style_set_text_font(&fonts[FONT_LABEL_MD], &font_smarthub_roboto_slab_medium_20);
    lv_style_set_text_font(&fonts[FONT_LABEL_LG], &font_smarthub_roboto_slab_bold_24);
    lv_style_set_text_font(&fonts[FONT_LABEL_XL], &font_smarthub_roboto_slab_bold_30);
    lv_style_set_text_font(&fonts[FONT_LABEL_2XL], &font_smarthub_roboto_slab_bold_50);
}

static void init_fonts_md(lv_style_t * fonts)
{
    lv_style_set_text_font(&fonts[FONT_HEADING_MD], &font_smarthub_roboto_slab_regular_30);
    lv_style_set_text_font(&fonts[FONT_HEADING_LG], &font_smarthub_roboto_slab_regular_60);
    lv_style_set_text_font(&fonts[FONT_HEADING_XL], &font_smarthub_roboto_slab_light_120);
    lv_style_set_text_font(&fonts[FONT_HEADING_XXL], &font_smarthub_roboto_slab_light_160);
    lv_style_set_text_font(&fonts[FONT_LABEL_XS], &font_smarthub_roboto_medium_12);
    lv_style_set_text_line_space(&fonts[FONT_LABEL_XS],
                                 30 * lv_font_get_line_height(&font_smarthub_roboto_medium_12) / 100); /* +30% */
    /* lv_style_set_text_letter_space(&fonts[FONT_LABEL_XS], 197 * lv_font_get_letter_space(&font_smarthub_roboto_medium_12) / 200); */ /* -1.5% */
    lv_style_set_text_font(&fonts[FONT_LABEL_SM], &font_smarthub_roboto_medium_16);
    lv_style_set_text_font(&fonts[FONT_LABEL_MD], &font_smarthub_roboto_medium_24);
    lv_style_set_text_font(&fonts[FONT_LABEL_LG], &font_smarthub_roboto_slab_bold_30);
    lv_style_set_text_font(&fonts[FONT_LABEL_XL], &font_smarthub_roboto_slab_bold_36);
    lv_style_set_text_font(&fonts[FONT_LABEL_2XL], &font_smarthub_roboto_slab_bold_60);
}

static void init_fonts_lg(lv_style_t * fonts)
{
    lv_style_set_text_font(&fonts[FONT_HEADING_MD], &font_smarthub_roboto_slab_regular_45);
    lv_style_set_text_font(&fonts[FONT_HEADING_LG], &font_smarthub_roboto_slab_regular_90);
    lv_style_set_text_font(&fonts[FONT_HEADING_XL], &font_smarthub_roboto_slab_light_180);
    lv_style_set_text_font(&fonts[FONT_HEADING_XXL], &font_smarthub_roboto_slab_light_240);
    lv_style_set_text_font(&fonts[FONT_LABEL_XS], &font_smarthub_roboto_medium_18);
    lv_style_set_text_line_space(&fonts[FONT_LABEL_XS],
                                 30 * lv_font_get_line_height(&font_smarthub_roboto_medium_18) / 100); /* +30% */
    /* lv_style_set_text_letter_space(&fonts[FONT_LABEL_XS], 197 * lv_font_get_letter_space(&font_smarthub_roboto_medium_18) / 200); */ /* -1.5% */
    lv_style_set_text_font(&fonts[FONT_LABEL_SM], &font_smarthub_roboto_medium_24);
    lv_style_set_text_font(&fonts[FONT_LABEL_MD], &font_smarthub_roboto_medium_36);
    lv_style_set_text_font(&fonts[FONT_LABEL_LG], &font_smarthub_roboto_slab_bold_45);
    lv_style_set_text_font(&fonts[FONT_LABEL_XL], &font_smarthub_roboto_slab_bold_54);
    lv_style_set_text_font(&fonts[FONT_LABEL_2XL], &font_smarthub_roboto_slab_bold_90);
}

static void theme_observer_cb(lv_observer_t * observer, lv_subject_t * subject)
{
    const smarthub_theme_t * th = lv_subject_get_pointer(subject);
    const smarthub_theme_t * th_other = th == &smarthub_theme_light ? &smarthub_theme_dark :
                                                &smarthub_theme_light;
    smarthub_ctx_t * c = lv_observer_get_user_data(observer);
...
static void free_ctx_event_cb(lv_event_t * e)
{
    ...
    smarthub_top_margin_deinit_subjects(c);
...
static void label_text_temperature_cb(lv_observer_t * observer, lv_subject_t * subject)
{
    ...
    smarthub_ctx_t * c = lv_obj_get_user_data(label);
