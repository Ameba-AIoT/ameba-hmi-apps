...
static void wifi_connect_ui(smarthub_ctx_t * c);
static void wifi_connect_ui_textarea_apply_styles(smarthub_ctx_t * c, lv_obj_t * ta);
...
static void wifi_connect_ui_save_ssid_and_password(smarthub_ctx_t * c);
static void wifi_connect_ui_end(smarthub_ctx_t * c);
static lv_obj_t * create_wifi(lv_obj_t * parent, smarthub_ctx_t * c);
static void wifi_icon_observer_cb(lv_observer_t * observer, lv_subject_t * subject);
static lv_obj_t * create_perfmon(lv_obj_t * parent, smarthub_ctx_t * c);
#if LV_USE_PERF_MONITOR
    static void perfmon_data_cb(lv_observer_t * observer, lv_subject_t * subject);
#endif
static lv_obj_t * create_settings(lv_obj_t * parent, smarthub_ctx_t * c);
static lv_obj_t * create_setting_label_cont(lv_obj_t * parent, const char * text, smarthub_ctx_t * c);
                                              ...
                                              smarthub_ctx_t * c)
{
    ...
    lv_obj_t * top_margin_right_cluster = smarthub_simple_container_create(top_margin, false, c->sz->gap[6],
...
static lv_obj_t * create_wifi(lv_obj_t * parent, smarthub_ctx_t * c)
{
    ...
    lv_obj_t * cont = smarthub_simple_container_create(settings, true, c->sz->gap[4], LV_FLEX_ALIGN_START);
...
static lv_obj_t * create_perfmon(lv_obj_t * parent, smarthub_ctx_t * c)
{
    ...
    lv_obj_t * cont = smarthub_simple_container_create(perfmon, true, 0, LV_FLEX_ALIGN_START);
    lv_obj_set_width(cont, LV_PCT(100));
