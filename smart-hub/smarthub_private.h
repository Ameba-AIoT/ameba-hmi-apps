/**
 * @file smarthub_private.h
 *
 */

#ifndef SMARTHUB_PRIVATE_H
#define SMARTHUB_PRIVATE_H
...
} smarthub_subject_groups_t;

typedef struct {
    const smarthub_sizes_t * sz;
    ...
    smarthub_api_t api;
    smarthub_subject_groups_t subject_groups;
    lv_array_t about_slides_array;
    bool about_slides_dir_exists;
} smarthub_ctx_t;

LV_ATTRIBUTE_EXTERN_DATA extern const smarthub_theme_t smarthub_theme_light;
LV_ATTRIBUTE_EXTERN_DATA extern const smarthub_theme_t smarthub_theme_dark;
LV_ATTRIBUTE_EXTERN_DATA extern const smarthub_sizes_t smarthub_sizes_all[SIZE_COUNT];
...
void smarthub_app_about(lv_obj_t * base_obj);
lv_obj_t * smarthub_top_margin_create(lv_obj_t * parent, int32_t pad_hor, bool show_time,
                                              smarthub_ctx_t * c);
void smarthub_top_margin_deinit_subjects(smarthub_ctx_t * c);
