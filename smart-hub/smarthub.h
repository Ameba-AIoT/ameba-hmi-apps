...
typedef void (*smarthub_exit_cb_t)(smarthub_api_t * api);
...
/**
 * Start the Smart Hub Demo on the default display, on the active screen.
 * This demo requires `LV_USE_DEMO_SMARTHUB` and `LV_FONT_FMT_TXT_LARGE`
 ...
 *                          If `NULL`, "lvgl/demos/smarthub/assets" will be used.
