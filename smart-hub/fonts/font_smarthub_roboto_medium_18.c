 ...
 * Size: 18 px
 * Bpp: 8
 * Opts: --bpp 8 --size 18 --no-compress --font Roboto-Medium.ttf --range 32-127,176,8226 --format lvgl -o font_smarthub_roboto_medium_18.c
 ******************************************************************************/
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_smarthub_roboto_medium_18 = {
#else
lv_font_t font_smarthub_roboto_medium_18 = {
#endif
