/**
 * @file smarthub_app_smart_home.c
 *
 */
...
static void create_widget_charging(smarthub_ctx_t * c, lv_obj_t * widgets);
...
static void create_widget4(smarthub_ctx_t * c, lv_obj_t * widgets);
static void door_observer_cb(lv_observer_t * observer, lv_subject_t * subject);
static lv_obj_t * create_widget5_door(smarthub_ctx_t * c, lv_obj_t * parent);
static void switch_observer_cb(lv_observer_t * observer, lv_subject_t * subject);
static lv_obj_t * create_switch(smarthub_ctx_t * c, lv_obj_t * parent, lv_image_dsc_t ** img_dsc_pair,
                                lv_subject_t * subject);
static lv_obj_t * create_lightbulbs_switch_with_label(smarthub_ctx_t * c, lv_obj_t * parent,
                                                      const char * label_text, lv_subject_t * subject);
static lv_obj_t * create_widget5_lightbulbs(smarthub_ctx_t * c, lv_obj_t * parent);
static lv_obj_t * create_widget5_zigbee_fan(smarthub_ctx_t * c, lv_obj_t * parent);
...
static lv_obj_t * create_slider(smarthub_ctx_t * c, lv_obj_t * parent, const char * label_text,
                                lv_image_dsc_t ** img_dsc_pair, lv_subject_t * subject);
static void create_widget5(smarthub_ctx_t * c, lv_obj_t * widgets);
...
void smarthub_app_smart_home(lv_obj_t * base_obj)
{
    ...
    lv_obj_t * top_margin = smarthub_top_margin_create(bg_cont,
                                                               c->sz == &smarthub_sizes_all[SIZE_SM] ? c->sz->gap[9] : c->sz->gap[10], true, c);
...
static void create_widget1(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    smarthub_label_bind_temperature(main_temp, &c->api.subjects.temperature_indoor, c);

    lv_obj_t * outdoor_temp_box = smarthub_simple_container_create(widget, true, c->sz->gap[2],
    ...
    smarthub_label_bind_temperature(outdoor_temp, &c->api.subjects.temperature_outdoor, c);
...
static void create_widget_charging(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    lv_obj_t * num_label_cont = smarthub_simple_container_create(widget,
                                                                         false,
                                                                         c->sz->gap[1],
                                                                         LV_FLEX_ALIGN_END);
...
static void create_widget3(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    lv_obj_t * music_labels_box = smarthub_simple_container_create(widget, true, c->sz->gap[1],
                                                                           LV_FLEX_ALIGN_START);
    ...
    lv_obj_t * controls = smarthub_simple_container_create(widget, false, 0, LV_FLEX_ALIGN_CENTER);
...
static void create_widget4(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    lv_obj_t * temperature_box = smarthub_simple_container_create(widget, true, c->sz->gap[5], LV_FLEX_ALIGN_START);
    ...
    lv_obj_t * temperature_label_box = smarthub_simple_container_create(temperature_box, true, c->sz->gap[1],
                                                                                LV_FLEX_ALIGN_START);
...
static lv_obj_t * create_lightbulbs_switch_with_label(smarthub_ctx_t * c, lv_obj_t * parent,
                                                      const char * label_text, lv_subject_t * subject)
{
    lv_obj_t * box = smarthub_simple_container_create(parent, true, c->sz->gap[3], LV_FLEX_ALIGN_CENTER);
...
static lv_obj_t * create_widget5_lightbulbs(smarthub_ctx_t * c, lv_obj_t * parent)
{
    ...
    lv_obj_t * switch_box = smarthub_simple_container_create(lightbulbs_box, false, c->sz->gap[7],
                                                                     LV_FLEX_ALIGN_END);
...
static lv_obj_t * create_widget5_zigbee_fan(smarthub_ctx_t * c, lv_obj_t * parent)
{
    lv_obj_t * box = smarthub_simple_container_create(parent, true, c->sz->gap[9], LV_FLEX_ALIGN_END);
...
static lv_obj_t * create_slider(smarthub_ctx_t * c, lv_obj_t * parent, const char * label_text,
                                lv_image_dsc_t ** img_dsc_pair, lv_subject_t * subject)
{
    lv_obj_t * box = smarthub_simple_container_create(parent, true, c->sz->gap[9], LV_FLEX_ALIGN_START);
    lv_obj_set_style_pad_top(box, c->sz->gap[5], 0);
    ...
    lv_obj_t * label_box = smarthub_simple_container_create(box, false, 0, LV_FLEX_ALIGN_CENTER);
