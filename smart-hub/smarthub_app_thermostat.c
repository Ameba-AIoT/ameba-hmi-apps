/**
 * @file smarthub_app_thermostat.c
 *
 */
...
static lv_obj_t * widget1_chart_label(smarthub_ctx_t * c, lv_obj_t * parent, const char * text);
...
static lv_obj_t * create_widget2_value(smarthub_ctx_t * c, lv_obj_t * parent, const char * title_val,
                                       const char * range_val, int32_t temperature_val);
static void create_widget2(smarthub_ctx_t * c, lv_obj_t * widgets);
static lv_obj_t * create_widget3_setting(smarthub_ctx_t * c, lv_obj_t * parent, const lv_image_dsc_t * img_dsc,
...
void smarthub_app_thermostat(lv_obj_t * base_obj)
{
...
static void create_widget1(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    lv_obj_t * consumed_box = smarthub_simple_container_create(widget, true, c->sz->gap[2], LV_FLEX_ALIGN_START);
    ...
    lv_obj_t * amount_box = smarthub_simple_container_create(consumed_box, false, c->sz->gap[1], LV_FLEX_ALIGN_END);
...
static lv_obj_t * create_widget2_value(smarthub_ctx_t * c, lv_obj_t * parent, const char * title_val,
                                       const char * range_val, int32_t temperature_val)
{
    lv_obj_t * box = smarthub_simple_container_create(parent, true, c->sz->gap[2], LV_FLEX_ALIGN_START);
    ...
    lv_obj_t * temperature_box = smarthub_simple_container_create(box, false, c->sz->gap[2], LV_FLEX_ALIGN_CENTER);
...
static void create_widget2(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    lv_obj_t * outer_slider_box = smarthub_simple_container_create(widget, true, c->sz->gap[4],
                                                                           LV_FLEX_ALIGN_START);
    lv_obj_set_width(outer_slider_box, LV_PCT(100));
    lv_obj_set_style_pad_top(outer_slider_box, c->sz->gap[5], 0);

    lv_obj_t * slider_box = smarthub_simple_container_create(outer_slider_box, false, 0, LV_FLEX_ALIGN_CENTER);
...
static void create_widget3(smarthub_ctx_t * c, lv_obj_t * widgets)
{
    ...
    lv_obj_set_style_radius(scale, 12, LV_PART_ITEMS);
    ...
    lv_obj_set_style_radius(scale, 12, LV_PART_INDICATOR);
    ...
    lv_obj_t * current_temperature_box = smarthub_simple_container_create(scale_and_arc_box, true, c->sz->gap[2],
    ...
    smarthub_label_bind_temperature(current_temperature_val_label, &c->api.subjects.thermostat_target_temperature,
                                            c);
    ...
    lv_obj_t * slider_box = smarthub_simple_container_create(widget, true, c->sz->gap[4], LV_FLEX_ALIGN_START);
    lv_obj_set_width(slider_box, LV_PCT(100));
